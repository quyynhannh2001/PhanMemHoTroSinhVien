...
@section('title','Giải quyết yêu cầu')
...
<div class="card card-primary mt-3">
  ...
  <div class="card-header">
    <h3 class="card-title">Đọc yêu cầu</h3>
  </div>
  <!-- /.card-header -->
  <!-- form start -->
  <form action="{{route('ruser.update',['ruser'=>$requestt->id])}}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    {{-- @method('PUT') --}}
    <div class="card-body">
      <div class="card-body p-0">
        ...
        <div class="mailbox-read-info pb-4">
          ...
          <span class="mailbox-read-time float-left">From: {{$requestt->student_id}}</span>
    ...
    <div class="card-body">
      ...
      <div class="card-body p-0">
        ...
        <div class="mailbox-read-message">
          ...
          <h5 style="font-weight: bold;">Nội dung: </h5>
        <div class="card-body">
          <textarea id="summernote" name="reply" rows="100" >
            {{-- <span>{{$requestt->req_content}}</span> --}}
            {{$requestt->reply}}
          </textarea>
          <span class="alert text-danger font-weight-bolder font-italic">{{ $errors->first('reply') }}</span>
        </div>
        </div>
        <div class="mailbox-read-message">
          <div class="form-group">
              {{-- <h5 style="font-weight: bold;">Trạng thái: </h5> --}}
              {{-- <span>{{$requestt->status}}</span> --}}
        ...
        <input type="hidden" name="user_id" value="{{Auth::guard('support')->user()->id}}">
