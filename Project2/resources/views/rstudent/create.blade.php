...
@section('title','Thêm mới yêu cầu')
...
<div class="card card-primary mt-3">
  <div class="card-header">
    <h3 class="card-title">Thêm Mới Yêu Cầu</h3>
  </div>
  <!-- /.card-header -->
  <!-- form start -->
  <form action="{{url('student/rstudent')}}" method="POST" enctype="multipart/form-data">
    @csrf
    {{-- @method('PUT') --}}
    <div class="card-body">
      ...
      <div class="card-body p-0">
        ...
        <div class="mailbox-read-info pb-4">
            <div class="row">
                ...
                <div class="col-11">
                    <input type="text" name="req_title" value="{{old('req_title')}}" class="form-control">
                    <span class="alert text-danger font-weight-bolder font-italic">{{ $errors->first('req_title') }}</span>
                </div>
        </div>
          <span class="mailbox-read-time float-left">From: {{Auth::guard('student')->user()->id}}</span>
            ...
            {{-- <span class="mailbox-read-time float-right">{{Carbon::now()}}</span></h6> --}}
        </div>
        ...
        <div class="card-body">
          ...
          <span class="alert text-danger font-weight-bolder font-italic">{{ $errors->first('req_content') }}</span>
        </div>
        </div>
      ...
      <div class="mailbox-read-message">
        <div class="form-group">
            {{-- <h5 style="font-weight: bold;">Trạng thái: </h5> --}}
