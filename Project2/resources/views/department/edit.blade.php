                  ...
                  <div class="card-body">
                    <div class="row">
                        <div class="col-6">
                          ...
                          <input type="text" name="name" class="form-control" value="{{$department->name}}" placeholder="">
                        ...
                        <div class="col-6">
                          ...
                          <input type="text" name="id" value="{{$department->id}}" class="form-control" placeholder="">
                      ...
                      <div class="col-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" name="phone" value="{{$department->phone}}" class="form-control"
                        ...
                        <div class="col-6">
                            ...
                            <input type="email" name="email" value="{{$department->email}}" class="form-control" placeholder="">
                    ...
                    <div class="mailbox-read-message">
                      ...
                      <div class="card-body">
                        <textarea id="summernote" name="note" value="{{$department->note}}" rows="100" >
                        </textarea>
                      </div>
                      </div>
