...
<div class="card card-primary mt-3">
    ...
    <div class="card-body">
      ...
      <div class="row">
          <div class="col-4">
            ...
            <input type="text" name="name" class="form-control" value="{{$student->name}}" placeholder="">
  ...
  <div class="row">
      ...
      <div class="col-6">
          ...
          <input type="text" name="address" value="{{$student->address}}" class="form-control" placeholder="">
  ...
  <div class="row">
      <div class="col-4">
          ...
          <input type="text" name="id" class="form-control" value="{{$student->id}}" placeholder="">
      ...
      <div class="col-4">
          <div class="form-group">
              ...
              <select class="form-control" name="status" value="{{$student->status}}">
                ...
                <option value="2" {{ $student->status == 2 ? 'selected' : '' }}>Nghỉ học</option>
  ...
  <div class="form-group">
      ...
      <input type="email" name="email" value="{{$student->email}}" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
    ...
    {{-- <div class="row">
          <div class="col-6">
              ...
              <input type="password" name="password" value="{{$student->password}}" class="form-control" id="exampleInputPassword1" placeholder="">
              </div>
          </div>
          <div class="col-6">
              <div class="form-group">
        ...
        {{-- <div class="form-group">
          <label for="exampleFormControlFile1">Hình ảnh</label>
          <input type="file" name="image" class="form-control-file" accept="image/*" value="{{$student->image}}" id="exampleFormControlFile1">
        </div> --}}
