<title>Trang Đăng Nhập Cho Sinh Viên</title>
...
<section class="login-block">
	...
	<div class="row">
		<div class="col-md-4 login-sec">
		    ...
		    <form class="login-form" method="POST" action="{{route('student.checklogin')}}">
          @csrf
  <div class="form-group">
    <label for="exampleInputEmail1" class="text-uppercase">Mã sinh viên</label>
    <input type="text" name="msv" value="{{old('msv')}}" class="form-control" placeholder="">
